...
public class RegionEightMove extends RegionMove{
    
    public RegionEightMove(RegionMovingStrategy move,byte startRow, byte startColumn, 
    ...
    public void fillRowByRow(Cell[][] cells){
        ...
        Location region = Location.Region_Eight;
        currentRow = startRow;
