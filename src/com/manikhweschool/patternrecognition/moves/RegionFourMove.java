...
public class RegionFourMove extends RegionMove{
    
    public RegionFourMove(RegionMovingStrategy move,byte startRow, byte startColumn, 
    ...
    public void fillRowByRow(Cell[][] cells){
        ...
        Location region = Location.Region_Four;
